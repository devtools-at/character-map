...
<p align="center">
  <a href="https://devtools.at/tools/character-map"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Browse Unicode characters</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/character-map">Try Online</a> •
...
**[Try Character Map online at DevTools.at →](https://devtools.at/tools/character-map)**
...
Browse Unicode characters. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/character-map';
